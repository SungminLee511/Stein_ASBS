"""
eval_rotgmm50.py — Evaluate RotGMM d=50 baseline vs KSD-ASBS.
Uses nearest-mode assignment (no threshold) for mode coverage.
...
EXPERIMENTS = {
    "rotgmm50_asbs": Path("/home/RESEARCH/Stein_ASBS/results/rotgmm50_asbs/seed_0"),
    "rotgmm50_ksd_asbs": Path("/home/RESEARCH/Stein_ASBS/results/rotgmm50_ksd_asbs/seed_0"),
}
...
def main():
    ...
    # Save
    out_path = RESULTS_DIR / "rotgmm50_results.json"
    ...
    print(f"{'='*60}")
    bl = all_results.get("rotgmm50_asbs", {})
    ksd = all_results.get("rotgmm50_ksd_asbs", {})
