"""
plot_rotgmm30.py — Generate RotGMM-30 visualization figures.
...
BASELINE_DIR = Path("/home/RESEARCH/Stein_ASBS/results/rotgmm30_asbs/seed_0")
KSD_DIR = Path("/home/RESEARCH/Stein_ASBS/results/rotgmm30_ksd_asbs/seed_0")
...
# In 30D, use nearest-mode assignment (no hard threshold)
# because expected L2 distance from N(μ, σ²I) is σ√D ≈ 0.5√30 ≈ 2.74
...
ax.set_title("RotGMM d=30: Mode Occupation (seed=0, N=2000)", fontsize=14, fontweight="bold")
...
plt.tight_layout()
fig.savefig(FIG_DIR / "rotgmm30_mode_occupation.png", dpi=150, bbox_inches="tight")
print(f"  Saved: {FIG_DIR / 'rotgmm30_mode_occupation.png'}")
plt.close()
...
fig.suptitle("RotGMM d=30: PCA Projection (seed=0, N=2000)", fontsize=15, fontweight="bold", y=1.02)
plt.tight_layout()
fig.savefig(FIG_DIR / "rotgmm30_pca_scatter.png", dpi=150, bbox_inches="tight")
print(f"  Saved: {FIG_DIR / 'rotgmm30_pca_scatter.png'}")
plt.close()
